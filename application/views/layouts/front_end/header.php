				...
				<?php if ($this->session->userdata('empresa')): ?>
					...
					<div id="navbarCollapse" class="collapse navbar-collapse">
						<ul class="navbar-nav mr-auto">
							...
							<?php if ($this->session->userdata('acesso_auxiliares') != 'N') : ?>
								<li class="nav-item dropdown">
									...
									<div class="dropdown-menu" aria-labelledby="navbarDropdownClientes">
										<?php if ($this->session->userdata('acesso_auxgerais') != 'N') : ?>
											<div class="dropdown-header"><span>Gerais</span></div>
											<a class="dropdown-item" href="<?= base_url('funcoes'); ?>">Funções</a>
											<a class="dropdown-item" href="<?= base_url('setores'); ?>">Setores</a>
										<?php endif; ?>
										<?php if ($this->session->userdata('acesso_auxfiscalizacao') != 'N') : ?>
											<div class="dropdown-header"><span>Fiscalização</span></div>
										...
										<?php endif; ?>
										<?php if ($this->session->userdata('acesso_auxlicencas') != 'N') : ?>
											<div class="dropdown-header"><span>Licenças</span></div>
										...
										<?php endif; ?>
										<?php if ($this->session->userdata('acesso_usuarios') != 'N'): ?>
							...
							<?php endif; ?>
							<?php if ($this->session->userdata('acesso_licencas') != 'N') : ?>
								<li class="nav-item dropdown">
