			...
			<?= form_open($form_relatorios, $form_attr); ?>
				<div class="card border border-gray-light">
					...
					<div class="card-body">
						...
						<?= form_hidden('ce_relatorio', $ce_relatorio); ?>
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
								<?= form_dropdown('tipo', $opt_tipo, 'S', $tipo) ?>
							</div>
							<?= form_label('Origem', 'origem', $label1) ?>
							<div class="col-sm-2">
								<?= form_dropdown('origem', $opt_origem, 'B', $origem) ?>
							</div>
							<?= form_label('Calcula?', 'calculo', $label1) ?>
							<div class="col-sm-2">
								<?= form_dropdown('calculo', $opt_calculo, '', $calculo) ?>
							</div>
						</div>
						<div class="form-group row">
