...
<script type="text/javascript">
	$(document).ready(function() {
		$('#tipo').change(function() {
			...
			$("#tipo_dados").val('').triggerHandler('change');
		});
		...
		var botao_remover = '<button class="btn btn-primary remove" type="button"><i class="fa fa-minus"></i>&nbsp;&nbsp;Remover</button>'
	});
</script>