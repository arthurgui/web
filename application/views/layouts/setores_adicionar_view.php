									...
									<div class="tab-content border-green-system border-top border-right border-bottom border-left p-2" id="myTabContent">
										<div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab1-tab">
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												...
												<div class="col-sm-3">
													<?= form_dropdown('acesso_auxiliares',$opt_acessos, set_value('acesso_auxiliares'), $select_auxiliares); ?>
												</div>
											</div>
											...
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												...
												<div class="col-sm-3">
													<?= form_dropdown('acesso_auxgerais',$opt_acessos, set_value('acesso_auxgerais'), $select_auxgerais); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxfiscalizacao" class="col-sm-2 col-form-label col-form-label text-right">Fiscalização:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_auxfiscalizacao',$opt_acessos, set_value('acesso_auxfiscalizacao'), $select_auxfiscalizacao); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxlicencas" class="col-sm-2 col-form-label col-form-label text-right">Licenças:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_auxlicencas',$opt_acessos, set_value('acesso_auxlicencas'), $select_auxlicencas); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxlicencas" class="col-sm-2 col-form-label col-form-label text-right">Usuários:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_usuarios',$opt_acessos, set_value('acesso_usuarios'), $select_usuarios); ?>
												</div>
											</div>
										</div>
										<div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab2-tab">
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												...
												<div class="col-sm-3">
													<?= form_dropdown('acesso_licencas',$opt_acessos, set_value('acesso_licencas'), $select_licencas); ?>
												</div>
											</div>
											<hr class="border-green-system">
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												...
												<div class="col-sm-3">
													<?= form_dropdown('acesso_protocolos',$opt_acessos, set_value('acesso_protocolos'), $select_protocolos); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxlicencas" class="col-sm-2 col-form-label col-form-label text-right">AN - Análises:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_analises',$opt_acessos, set_value('acesso_analises'), $select_analises); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxlicencas" class="col-sm-2 col-form-label col-form-label text-right">AP - Aprovacoes:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_aprovacoes',$opt_acessos, set_value('acesso_aprovacoes'), $select_aprovacoes); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxlicencas" class="col-sm-2 col-form-label col-form-label text-right">AU - Auditorias:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_auditoria',$opt_acessos, set_value('acesso_auditoria'), $select_auditoria); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxlicencas" class="col-sm-2 col-form-label col-form-label text-right">FI - Finalizados:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_finalizados',$opt_acessos, set_value('acesso_finalizados'), $select_finalizados); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxlicencas" class="col-sm-2 col-form-label col-form-label text-right">IN - Indeferidos:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_indeferidos',$opt_acessos, set_value('acesso_indeferidos'), $select_indeferidos); ?>
												</div>
											</div>
										</div>
										<div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab3-tab">
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxiliares" class="col-sm-2 col-form-label col-form-label text-right">Acesso:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_fiscalizacao',$opt_acessos, set_value('acesso_fiscalizacao'), $select_fiscalizacao); ?>
												</div>
											</div>
											<hr class="border-green-system">
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												...
												<div class="col-sm-3">
													<?= form_dropdown('acesso_fisadicionar',$opt_acessos, set_value('acesso_fisadicionar'), $select_fisadicionar); ?>
												</div>
											</div>
											<div class="form-group row mt-auto mr-auto mb-2 ml-auto">
												<label for="acesso_auxiliares" class="col-sm-2 col-form-label col-form-label text-right">PD - A Distribuir:</label>
												<div class="col-sm-3">
													<?= form_dropdown('acesso_fisdistribuir',$opt_acessos, set_value('acesso_fisdistribuir'), $select_fisdistribuir); ?>
												</div>
											</div>
										</div>
									</div>
